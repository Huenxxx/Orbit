...
export function GameCard({ game, variant = 'grid', onSelect }: GameCardProps) {
    ...
    const showInExplorer = async () => {
        if (!game.executablePath) {
            showError('Sin ejecutable', 'Este juego no tiene una ruta de ejecutable configurada');
            return;
        }
        ...
        try {
            const { ipcRenderer } = electronRequire ? electronRequire('electron') : { ipcRenderer: null };
            if (ipcRenderer) {
                await ipcRenderer.invoke('show-in-explorer', game.executablePath);
            }
        } catch (error) {
            showError('Error', 'No se pudo mostrar el ejecutable');
        }
    };
    ...
    const getContextMenuItems = (): ContextMenuItem[] => {
        return [
            ...
            {
                id: 'open-dir',
                label: 'Abrir directorio del juego',
            ...
            {
                id: 'favorite',
                label: game.isFavorite ? 'Quitar de favoritos' : 'Añadir a favoritos',
                icon: <Heart size={16} />,
            ...
            <>
                ...
                >
                    ...
                    <div className="game-list-actions">
                        ...
                        <button className="btn-play-small" onClick={(e) => handlePlay(e)}>
        ...
        <>
            ...
            >
                ...
                <div className="game-cover">
                    ...
                    >
                        <button className="btn-play" onClick={(e) => handlePlay(e)}>
                    ...
                    {showMenu && (
                        ...
                        >
                            ...
                            <button onClick={openDirectory}>
                                <FolderOpen size={14} /> Abrir directorio
                            </button>
                            <button onClick={showInExplorer}>
                                <ExternalLink size={14} /> Ver ejecutable
                            </button>
